    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>部门管理编辑</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
          <el-form class="commonForm"   label-width="120px" :model="formData" ref="formData" :rules="formrules">
            ...
            <el-form-item label="层级" prop="level" >
              <el-input-number v-model="formData.level" :min="1" disabled></el-input-number>
            </el-form-item>
          ...
          var validateName = (rule, value, callback) => {
            ...
            return {
              ...
              formrules: {
                  ...
                  isRealDept:[
        						{ required: true, message: '请输入真实部门', trigger: 'blur' }
        					],
                  parentDept:[
              ...
              realOptions:[{'value':1,'label':'是'},{'value':0,'label':'否'}]
            }
        },
        created() {
        ...
        methods: {
          ...
          departTreeData(){
            ...
            axios.get('/api/v1/org/dept/list/tree',{
                params:{
                  org_id:_this.$route.query.orl_id
                }
          ...
          saveCancel(formName){
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                  axios.post('/api/v1/org/dept/upd', {
                  ...
                  .catch(function (error) {
                    if(error.response.data.errorCode=='7'){
                      window.sessionStorage.removeItem('access_token', '')
                      _this.$router.push({ path: 'login'})
                    }else{
                      _this.$message({
          ...
          formDataSet(){
            ...
            this.formData.level=this.$route.query.level
            this.formData.name=this.$route.query.name
            this.formData.sort=this.$route.query.sort
            this.formData.type=this.$route.query.type
            this.orl_id=this.$route.query.orl_id
            this.formData.isRealDept=this.$route.query.isRealDept
            this.formData.parentDept=this.$route.query.parentDept
          }
