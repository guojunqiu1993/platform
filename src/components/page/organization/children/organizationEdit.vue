    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>基本信息编辑</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
          <el-form class="commonForm"   label-width="110px" :model="formData" ref="formData" :rules="formrules">
            <el-form-item label="客户标识" prop="clientsign">
              <el-select v-model="formData.clientsign" placeholder="请选择" disabled>
                  <el-option
...
            },
          saveCancel(formName){
            let _this=this
            let customer_types=''
            if(_this.formData.customer_type=='正式'){
              customer_types=1
            }else{customer_types=0}
            this.$refs[formName].validate((valid) => {
                if (valid) {
                  axios.post('/api/v1/org/upd', {
          ...
          formDataSet(){
            ...
            this.formData.customer_name=this.$route.query.customer_name
            this.formData.customer_type=this.$route.query.customer_type
            this.formData.sys_sign=this.$route.query.sys_sign
            this.formData.account_sign=this.$route.query.account_sign
            this.formData.province=this.$route.query.province
            // this.formData.city=this.$route.query.city
            this.formData.contact=this.$route.query.contact
            this.formData.dept=this.$route.query.dept
            this.formData.phone=this.$route.query.phone
            this.formData.email=this.$route.query.email
            this.formData.remark=this.$route.query.remark
            this.formData.sign_type=this.$route.query.sign_type
            this.formData.clientsign=this.$route.query.clientsign
            this.getProv(this.$route.query.province)
            this.formData.city=this.$route.query.city
          },
          //客户标识
          legalData(){
